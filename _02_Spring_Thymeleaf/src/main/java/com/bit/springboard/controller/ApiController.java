...
public class ApiController {
    ...
    public ResponseEntity<?> findAll() {
        ResponseDto<MemberDto> responseDto = new ResponseDto<>();
        try {
            List<MemberDto> allMemberDto = memberService.findAll();
            responseDto.setStatusCode(HttpStatus.OK.value());
            responseDto.setStatusMessage("OK");
            responseDto.setDataList(allMemberDto);
    ...
    public ResponseEntity<?> findById(@Parameter(description = "조회할 Member의 id")
    ...
    public ResponseEntity<?> remove(@Parameter(description = "삭제할 Member의 id")
                                        @PathVariable ("id") int id) {
        ResponseDto<MemberDto> responseDto = new ResponseDto<>();
        try {
    ...
    public ResponseEntity<?> modify(@Parameter(description = "수정할 Member의 id") @PathVariable ("id") int id,
                                    @Parameter(description = "변경할 Member의 password, email, nickname, tel") MemberDto memberDto) {
        // x-www-form-urlencoded 형태는 @ModelAttribute나 @RequestParam으로 데이터를 전송받아 사용했다.
